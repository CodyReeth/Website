...
loader.load('dist/assets/untitled.glb', (gltf) => {
...
loader.load('dist/assets/desk.glb', (gltf) => {
    const model = gltf.scene
...
loader.load('dist/assets/pc.glb', (gltf) => {
    const model = gltf.scene
...
loader.load('dist/assets/monitor.glb', (gltf) => {
    const model = gltf.scene
...
loader.load('dist/assets/chair.glb', (gltf) => {
    const model = gltf.scene
    //model.position.set(-.3,1.77,-2);
